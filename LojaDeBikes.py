...
class Loja(object):
    def __init__(self, estoqueBikes, caixa):
    ...
    def valorTempoAluguelBikes(self, numeroBikes, tempoAluguel):
        while numeroBikes > self.estoqueBikes:
            ...
            validaAluguel = input("Você ainda quer alugar alguma bike? Resp: Sim ou Não")
        ...
        try:
            if tempoAluguel == 'hora':
                ...
                print("Pedido recebido - {numeroBikes} durante {tempoAluguel} hora/s, total de R$ {valorConta} reais, pedido confirmado || Total bikes disponíveis no estoque: {self.estoqueBikes}.")
            ...
            if tempoAluguel == 'dia':
                ...
                print("Pedido recebido - {numeroBikes} durante {tempoAluguel} dia/s solicitadas, total de R$ {valorConta} reais, pedido confirmado || Total bikes disponíveis no estoque: {self.estoqueBikes}.")
                numeroBikesRecebidos = numeroBikes
                return True
            ...
            if tempoAluguel == 'semana':
                ...
                print("Pedido recebido - {numeroBikes} durante {tempoAluguel} semana/s solicitadas, total de R$ {valorConta} reais, pedido confirmado || Total bikes disponíveis no estoque: {self.estoqueBikes}.") 
                numeroBikesRecebidos = numeroBikes
                return True
